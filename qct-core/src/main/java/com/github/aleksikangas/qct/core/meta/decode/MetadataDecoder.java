...
public final class MetadataDecoder {
  public static Metadata decode(final FileChannel fileChannel) {
    return new Metadata(MagicNumber.of(QctReader.readInt(fileChannel, Metadata.BYTE_OFFSET)),
                        FileFormatVersion.of(QctReader.readInt(fileChannel, Metadata.BYTE_OFFSET + 0x04L)),
                        ...
                        Flag.flagsOf(QctReader.readInt(fileChannel, Metadata.BYTE_OFFSET + 0x40)),
                        ...
                        ExtendedDataDecoder.decode(fileChannel,
                                                   QctReader.readPointer(fileChannel, Metadata.BYTE_OFFSET + 0x54L)),
                        MapOutlineDecoder.decode(fileChannel, Metadata.BYTE_OFFSET + 0x58L));
  }
